...
masks=sorted(glob.glob('/data2/tissue_seg/working/detrend_despike_func2anat/'+sub+'_session_1/tseg_anat_preproc/app_xfm_lin_csf_pve/segment_prob_0_flirt.nii.gz'))
data_dict={}
label_dict={}
coord_dict={}
...
subset=n_sample_1*0.1

data_1=data_1[0:subset]
target_1=target_1[0:subset]
coord_1=coord_1[0:subset]
...
if os.path.isfile('/data2/tissue_seg/svr_res/pred_img_'+sub+'_svr_pred.txt'):
    os.remove('/data2/tissue_seg/svr_res/pred_img_'+sub+'_svr_pred.txt')
...
for prediction in predictions:
    ...
    nb.nifti1.save(op_img, '/data2/tissue_seg/svr_res/pred_img_'+prediction+'_'+sub+'.nii.gz')
